"""
Beginner lab: Scrapy concepts without requiring Scrapy to be installed.

Goal:
Help learners understand what Scrapy adds beyond BeautifulSoup before they
look at the optional spider file.
...
def explain_scrapy_concepts() -> list[tuple[str, str]]:
    """Return Scrapy terms in a learner-friendly order."""
...
def simulate_spider_parse(html_text: str) -> list[dict[str, str]]:
    ...
    In this beginner bridge, we use BeautifulSoup so learners can run the file
    without installing Scrapy.
    """
