"""
Beginner lab: loading and inspecting HTML.

Goal:
Before learners scrape data, they should understand what HTML text looks like,
how to load it, and how BeautifulSoup helps find page elements.
