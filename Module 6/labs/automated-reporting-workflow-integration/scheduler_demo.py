...
Use this for classroom demonstration:

    python scheduler_demo.py --demo-once

Use this to run a simple every-minute scheduler for testing:

    python scheduler_demo.py --run-loop
"""
...
PIPELINE = LAB_DIR / "monthly_reporting_pipeline.py"
...
def main() -> None:
    ...
    if args.demo_once:
        ...
        print("No action selected. Use --demo-once for classroom practice or --run-loop for scheduler demo.")
