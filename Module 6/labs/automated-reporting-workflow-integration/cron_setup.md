...
```text
30 7 1 * * cd "$HOME/Desktop/Trainingcred Institute/Module 6/labs/automated-reporting-workflow-integration" && ../../../.venv/bin/python monthly_reporting_pipeline.py --refresh-data --dry-run-email >> outputs/cron_monthly_report.log 2>&1
```
